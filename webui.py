    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete Cookie-Fooocus temp images, only keep gradio temp images
...
shared.gradio_root = gr.Blocks(title=title).queue(
    max_size=8,         # Cap queued requests — prevents thread/memory exhaustion
    default_concurrency_limit=2,  # Max simultaneous generation jobs
)
